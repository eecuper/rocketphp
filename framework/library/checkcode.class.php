...
class checkcode {
	...
	//设置随机生成因子
	public $charset1 = 'abcdefghkmnprstuvwyzABCDEFGHKLMNPRSTUVWYZ23456789';
	public $charset2 = '0123456789';
	//设置背景色
	...
	function __construct($complex = false) {
		$this->font = str_replace('\\','/',dirname(__FILE__)).'/fonts/elephant.ttf';
		$this->charset = $complex ? $this->charset1 : $this->charset2;
	}
	...
	public function doimage() {
		...
		//设置背景色
		$background = 
		imagecolorallocate($this->img,hexdec(substr($this->background, 1,2)),hexdec(substr($this->background, 3,2)),hexdec(substr($this->background, 5,2)));
		//画一个柜形，设置背景颜色。
